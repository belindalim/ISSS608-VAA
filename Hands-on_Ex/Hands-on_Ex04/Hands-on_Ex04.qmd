...
Additional Plots for my learning purposes:

Include another category "Gender" for the dots. 
...
ggplot(exam, 
  ...
  geom_boxplot(width = 0.20,
               outlier.shape = NA) +
  stat_dots(aes(fill = GENDER),
            color = NA,  
            side = "left", 
            justification = 1.2, 
            binwidth = 0.5,
            dotsize = 1.5) +
  scale_fill_manual(values = c("Female" = "darkred", "Male" = "steelblue")) +
  coord_flip() +
  theme_economist()+
  theme(
