...
One of the major limitation of the correlation matrix is that the scatter plots appear very cluttered when the number of observations is relatively large (i.e. more than 500 observations). To over come this problem, **Corrgram** data visualisation technique suggested by D. J. Murdoch and E. D. Chow (19915) and Friendly, M (2002) and will be used.
...
grouped_ggcorrmat(
  ...
  ggcorrplot.args = list(outline.color = "black", 
                         hc.order = TRUE,
                         tl.cex = 8,         # axis label font size
                         lab_size = 3        # correlation coefficient font size inside boxes
  ),
...
eel free to change the *method* argument to other supported visual geometrics.
...
## **15.8 Reordering a correlation matrix using hclust**
