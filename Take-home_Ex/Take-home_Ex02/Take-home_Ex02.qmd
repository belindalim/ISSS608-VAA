...
## **4.2 Find Works that influenced Sailor's works**
...
## **4.3 Find Creators of Works that influenced Sailor's works**
...
## **4.3 Check Sailor's group membership and ID**
...
## **5.2 Remove Sailor's work if not linked to other works**
...
## **5.2 Remove Ivy Echo's work if not linked to other works**
...
## **6.1 Visualising Sailor's Influencers (non-interactive)**
...
## **6.2 Visualising Sailor's Influencers (Interactive)**
...
## **7.5 Musicians whom were directly influenced by Sailor/ Ivy Echos**
...
## **7.6 Musicians whom were directly influenced by Sailor/ Ivy Echos**
